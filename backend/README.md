...
## Project Structure
    ...
    ├── mithileshtestapp_de_26368  # Django project configurations
...
1. Clone this repo and `cd mithileshtestapp_de_26368`
...
2. Clone this repo and `cd mithileshtestapp_de_26368`
